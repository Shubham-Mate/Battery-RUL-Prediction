...
class CNN_DBLSTM_Model(torch.nn.Module):
    def __init__(self, cnn_hidden_dims, lstm_hidden_dims, lstm_layers):
        ...
        self.lstm_block = torch.nn.LSTM(cnn_hidden_dims, hidden_size=lstm_hidden_dims, num_layers=lstm_layers, batch_first=True, bidirectional=True)
